...
#region Monobehaviour
        ...
        private void OnDrawGizmosSelected()
        {
            if (IsInLadderArea()) {
                ...
                Gizmos.DrawCube(this.onLadderState.Area.center, this.onLadderState.Area.extents * 2);

                Gizmos.color = (this.onLadderState.AreaZone == LadderZone.Top)
                    ? new Color(1.0f, 0.92f, 0.016f, 1.0f)
                    : Color.white;
                Gizmos.DrawWireCube(this.onLadderState.TopArea.center, this.onLadderState.TopArea.extents * 2);

                Gizmos.color = (this.onLadderState.AreaZone == LadderZone.Bottom)
                    ? new Color(1.0f, 0.92f, 0.016f, 1.0f)
                    : Color.white;
                Gizmos.DrawWireCube(this.onLadderState.BottomArea.center, this.onLadderState.BottomArea.extents * 2);

                if (IsRestrictedOnLadder()) {
                    Gizmos.color = Color.red;
                    Gizmos.DrawWireCube(this.onLadderState.RestrictedArea.center, this.onLadderState.RestrictedArea.extents * 2);
                }
            }
